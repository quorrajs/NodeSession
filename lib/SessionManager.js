...
SessionManager.prototype.__createSessionModel = function () {
    var self = this;
    var waterlineConnectionName = crypto.randomBytes(5).toString('hex');
    var adapters = {};
    var orm = new Waterline();
    var modelReady = false;
    var SessionModel = Waterline.Collection.extend({
        identity: this.__config.table,
        connection: waterlineConnectionName,
        migrate: 'safe',
        autoCreatedAt: false,
        autoUpdatedAt: false,
        attributes: {
    ...
    initConf.connections[waterlineConnectionName] = this.__config.connection;
